...
def calculate_demographic_data(print_data=True):
    ...
    average_age_men = round(df[df['sex'] == 'Male']['age'].mean().item(), 1)

    # What is the percentage of people who have a Bachelor's degree?
    percentage_bachelors = round((df['education'] == 'Bachelors').mean().item() * 100, 1)
    ...
    higher_education_rich = round(
        (higher_education_df[higher_education_df['salary'] == '>50K'].shape[0] /
         higher_education_df.shape[0]) * 100, 1)
    
    lower_education_rich = round(
        (lower_education_df[lower_education_df['salary'] == '>50K'].shape[0] /
         lower_education_df.shape[0]) * 100, 1)
